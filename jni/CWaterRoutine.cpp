...
CWaterRoutine::~CWaterRoutine()
{
	LOGD("CWaterRoutine", "~CWaterRoutine");
	// Cleanup
...
{
	LOGD("CWaterRoutine", "DrawWaterNoLight");
//  int ox, oy;
  int dx, dy;
  int x, y;
  DWORD c;
...
//  LOGD("CWaterRoutine", "DrawWaterWithLight2");
}
